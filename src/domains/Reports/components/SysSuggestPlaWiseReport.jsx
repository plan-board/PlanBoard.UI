...
const SysSuggestPlaWiseReport = ({ toggleState }) => {
  ...
  const fetchGridData = async () => {
    if (fyId != 0) {
      ...
      fetch(
        ServerAPI +
          `api/GetReportWithOutParameter/SysSuggplanvsEditvsActual/${fyId}/${employeeId}`
      )
        .then((res) => res.json())
        .then((res) => {
          if (res) {
  ...
  const handleToolbarClick = (args) => {
    ...
    let export_file_name = "SysSuggestPlaWiseReport" + cur_timestamp;
    ...
    <>
      ...
      <Row>
        <Col style={{ marginTop: "10px" }}>
          <GridComponent
            locale="en-Us"
            id="SysSuggestPlaWiseReport_id"
            key="SysSuggestPlaWiseReport_id"
            allowTextWrap={true}
            allowResizing={false}
            dataSource={gridData}
            height={"450px"}
          ...
          >
            <ColumnsDirective>
              ...
              />
              <ColumnDirective
                field="Apr_Month_Value_V0"
                headerText={"Apr Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              <ColumnDirective
                field="May_Month_Value_V0"
                headerText={"May Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              <ColumnDirective
                field="Jun_Month_Value_V0"
                headerText={"Jun Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              <ColumnDirective
                field="Jul_Month_Value_V0"
                headerText={"Jul Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              <ColumnDirective
                field="Aug_Month_Value_V0"
                headerText={"Aug Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              />
              <ColumnDirective
                field="Sep_Month_Value_V0"
                headerText={"Sep Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              />
              <ColumnDirective
                field="Oct_Month_Value_V0"
                headerText={"Oct Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              />
              <ColumnDirective
                field="Nov_Month_Value_V0"
                headerText={"Nov Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              />
              <ColumnDirective
                field="Dec_Month_Value_V0"
                headerText={"Dec Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              />
              <ColumnDirective
                field="Jan_Month_Value_V0"
                headerText={"Jan Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              />
              <ColumnDirective
                field="Feb_Month_Value_V0"
                headerText={"Feb Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
              ...
              />
              <ColumnDirective
                field="Mar_Month_Value_V0"
                headerText={"Mar Sugg Plan"}
                // width="160"
              />
              <ColumnDirective
...
export default SysSuggestPlaWiseReport;
