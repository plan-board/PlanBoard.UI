...
const DealerMasterReport = ({ toggleState }) => {
  ...
  const fetchGridData = async () => {
    ...
    fetch(
      ServerAPI + `api/GetReportWithOutParameter/DealerMaster/${employeeId}`
    )
      .then((res) => res.json())
      .then((res) => {
        if (res) {
  ...
  const handleToolbarClick = (args) => {
    ...
    let export_file_name = "DealerMasterReport" + cur_timestamp;
        ...
        <Col>
          ...
          >
            <ColumnsDirective>
              ...
              />
               <ColumnDirective
                field="parentdalercode"
                headerText={"Parent Dealer Code"}
                // width="220"
              />
              <ColumnDirective
                field="fulladdress"
...
export default DealerMasterReport;
