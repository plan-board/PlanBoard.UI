...
const VisitPlanPurposeReport = ({ toggleState }) => {
  ...
  const fetchGridData = async () => {
    ...
    fetch(
      ServerAPI +
        `api/GetReport/VisitPlanReport/${gridFormDetails.formDate}/${gridFormDetails.toDate}/${employeeId}`
    )
      .then((res) => res.json())
      .then((res) => {
        if (res) {
  ...
  const handleToolbarClick = (args) => {
    ...
    let export_file_name = "VisitPlanReport" + cur_timestamp;
...
export default VisitPlanPurposeReport;
