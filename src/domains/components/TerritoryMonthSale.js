            ...
            headers.push(
                <Fragment >
                    <td className={`  ${monName === mStartName ? "active" : ""}`}> 
                        {fNWCommas(item[`${monName}_Month_Value_v1`])} <hr className="hr0" /> {fNWCommas(item[`${monName}_Month_Sale`])} {GetPercent(item[`${monName}_Month_Sale`], item[`${monName}_Month_Value_v1`])}
                    </td>
                </Fragment>
            );
        }
