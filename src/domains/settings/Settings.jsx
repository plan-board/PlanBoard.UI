...
import NewProductMaster from "./Components/newProductPlanning";
    ...
    <div className="main" style={{ marginLeft: flag ? "150px" : "0px" }}>
      ...
      <div class="card-box lightblue">
        <div className="w3-bar tab-container">
          ...
          <div
            className={
              toggleState === 7 ? "w3-button tab tab-active" : "w3-button tab"
            }
            onClick={() => toggleTab(7)}
          >
            <span className="h6">
        ...
        <div class="row w-100">
          <div className="full">
            ...
            <div
              className={toggleState === 7 ? "  " : " w3-hide  "}
              onClick={() => toggleTab(7)}
            >
              {toggleState === 7 && (
                <NewProductMaster toggleState={toggleState} />
              )}
            </div>
          </div>
        </div>
